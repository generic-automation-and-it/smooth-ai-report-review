...
The `minimize-previous-reviews.sh` script is integrated into the `.github/workflows/gemini-cli-code-review.yml` workflow:
...
- **Workflow**: `.github/workflows/gemini-cli-code-review.yml`
