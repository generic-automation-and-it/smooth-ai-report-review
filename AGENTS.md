...
| 2026-06-13 | `npm-publish.yml` now publishes on `.agents/skills/**` changes merged to `main`, supports manual dispatch, keeps semver tag releases, and skips already-published versions. | LADR-038 |
